        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Client_number = table.Column<string>(type: "nchar(50)", fixedLength: true, maxLength: 50, nullable: false),
                    ...
                    Client_Birthday = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    driver_waiting_price = table.Column<int>(type: "int", nullable: true),
                    client_waiting_price = table.Column<int>(type: "int", nullable: true),
                    lowest_distance = table.Column<double>(type: "float", nullable: true),
                    latency_price = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    driverarrivingtime = table.Column<DateTime>(type: "datetime", nullable: true),
                    clientarrivingtime = table.Column<DateTime>(type: "datetime", nullable: true),
                    orderstarttime = table.Column<DateTime>(type: "datetime", nullable: true),
                    waitingtime = table.Column<DateTime>(type: "datetime", nullable: true),
                    arrivingtime = table.Column<DateTime>(type: "datetime", nullable: true),
                    estimatedarrivingtime = table.Column<DateTime>(type: "datetime", nullable: true)
                },
                constraints: table =>
                {
